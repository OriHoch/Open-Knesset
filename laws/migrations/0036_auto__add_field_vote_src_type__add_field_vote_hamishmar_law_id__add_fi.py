...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vote.src_type'
        db.add_column(u'laws_vote', 'src_type',
                      self.gf('django.db.models.fields.CharField')(default='knesset', max_length=10),
                      keep_default=False)

        # Adding field 'Vote.hamishmar_law_id'
        db.add_column(u'laws_vote', 'hamishmar_law_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vote.hamishmar_vote_stage'
        db.add_column(u'laws_vote', 'hamishmar_vote_stage',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vote.hamishmar_protocol_url'
        db.add_column(u'laws_vote', 'hamishmar_protocol_url',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vote.src_type'
        db.delete_column(u'laws_vote', 'src_type')

        # Deleting field 'Vote.hamishmar_law_id'
        db.delete_column(u'laws_vote', 'hamishmar_law_id')

        # Deleting field 'Vote.hamishmar_vote_stage'
        db.delete_column(u'laws_vote', 'hamishmar_vote_stage')

        # Deleting field 'Vote.hamishmar_protocol_url'
        db.delete_column(u'laws_vote', 'hamishmar_protocol_url')
    ...
    models = {
        ...
        u'laws.vote': {
            ...
            'hamishmar_law_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'hamishmar_protocol_url': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'hamishmar_vote_stage': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'src_type': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'src_url': ('django.db.models.fields.URLField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'summary': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'laws.voteaction': {
            ...
            'vote': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'actions'", 'to': u"orm['laws.Vote']"})
        },
