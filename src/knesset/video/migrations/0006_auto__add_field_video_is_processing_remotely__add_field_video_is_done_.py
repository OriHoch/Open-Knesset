...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.is_processing_remotely'
        db.add_column('video_video', 'is_processing_remotely', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Video.is_done_processing'
        db.add_column('video_video', 'is_done_processing', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video.is_processing_remotely'
        db.delete_column('video_video', 'is_processing_remotely')

        # Deleting field 'Video.is_done_processing'
        db.delete_column('video_video', 'is_done_processing')
